...
def Data():
    ...
    if Again == 'a':
        ...
        while open_file:
            try:
                choice = input('\nenter a file name to be opened ').title()
                print('\nprocessing...\n')
                ...
                error = input(f'\n*{choice}.txt not found! or invalid input\nenter \'a\' to add another data\nenter \'e\' to exit or any other key to retry '.title()).title()
                if error == "A":
                    break
...
def main(Data):
    ...
    while head:
        ...
        elif username == Administration.admin_username:
            print('\nAlmost there!')
